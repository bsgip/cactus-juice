...
from cactus_juice.csipaus.sep2 import (
    convert_lfdi_to_sfdi,
    hex_binary_equal,
    lfdi_from_cert_bytes,
    sum_digits,
)
...
def test_lfdi_from_cert_bytes():

    assert lfdi_from_cert_bytes(CERTIFICATE_CONTENTS) == "854D10A201CA99E5E90D3C3E1F9BC1C3BD075F3B"
